...
from app.ui.handlers.cleaners import (clean_participant_inputs,
...
from app.ui.validators import (validate_participant_inputs,
...
from settings.ui.const import (CATEGORY_TITLE_INPUT_COORDS,
...
def clicked_open_edit_category_toplevel(self) -> None:
    if validate_event_name_exists(self=self) is True:
        ...
        create_grid_size_radio(window=category_frame_window,
...
def unregister_participant(self) -> None:
    ...
    if validate_participant_exists(
        ...
        for index, participant in enumerate(
            ...
            participant_string = get_participant_string(
